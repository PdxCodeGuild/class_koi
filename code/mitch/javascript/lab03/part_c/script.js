...
run_simulation = function() {
    ...
    return phrase = `****** This gambling simulator just played the 'Pick Six' lottery 100,000 times. ******
        <br/>There were ${num_of_winning_tickets} winning tickets.
        <br/>Total won: $${earnings.toFixed(2)}
        <br/>Starting at $0.00, the final balance after 100,000 games is:  $${balance.toFixed(2)}
        <br/>Your ROI (Return On Investment) is: ${return_on_investment.toFixed(2)}%`
