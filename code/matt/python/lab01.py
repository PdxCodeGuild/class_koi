...
# Version 1
""" 
distance = input('Please enter the number of feet you would like to convert to meters: ') # ask for user to input distance in feet
print(f'{distance} ft is {float(distance) * .3048} m.') # convert to meters and print results
"""
...
while True: # loop for validating unit entry against dictionary
    start_unit = input('Please enter the unit of measurement for that length/distance (valid options are ft, mi, m, & km): ')
...
# display results
print(f'{distance} {start_unit} is equal to {distance * converter[start_unit]} m')
"""
