...
if x >= 10 and x <= 20:
    print(teens[x]) # printing between 10 and 20
elif x >= 0 and x <= 9:
    print(ones[x]) # printing between 0 and 9
else: 
    tens_digit = x // 10
    ones_digit = x % 10 
    hundreds_digit = x // 100 # if x were 300, dividing x by 100 would give the one digit - 3 + 'hundred'
    print(tens[tens_digit] + ' ', ones[ones_digit]) # between 21 and 99
