...
elif ones_digit == 0 and x < 99: # fixed
...
if x >= 0 and x <= 9:
    ...
    print(teens[x]) # works
elif ones_digit == 0 and x < 100: # fixed
    print(tens[tens_digit])
elif x >= 21 and x <= 99:
...
elif ones_digit == 0 and x > 100:
    print(f'{ones[hundreds_digit]} hundred {tens[tens_digit]}') # fixed
elif tens_digit == 0 and x > 100:
    print(f'{ones[hundreds_digit]} hundred {ones[ones_digit]}')
else:
